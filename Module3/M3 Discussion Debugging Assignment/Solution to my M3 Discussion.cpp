...
* File Name : M3 Discussion; Debugging Assignment
* Date: 3 / 28 / 2024
*
...
#include <iostream>
#include <conio.h>
#include <string> //Error 1: Program includes strings, so need to include this one. 
...
int main()
{
    ...
    return 0; // Error 2: need to have the 0 after return 
