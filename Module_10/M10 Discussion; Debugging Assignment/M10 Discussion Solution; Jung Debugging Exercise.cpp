...
* File Name: M10 Discussion Solution; Debugging Assignment
* Date: 5/16/2024
*
...
int main()
{
    ...
    double radius; //Error 1: Changed typo "doub" to "double" 
...
double calculateCircumference(double* radius)
{
    return 2 * PI * (*radius); //Error 2: "PIEE" is not the correct one, so changed to "PI" 
}
