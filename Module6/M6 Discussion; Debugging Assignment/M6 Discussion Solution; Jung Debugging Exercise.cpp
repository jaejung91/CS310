...
* File Name: M6 Discussion Solution; Debugging Assignment
* Date: 4/18/2024
*
...
int main()
{
    ...
    cout << "Enter a number for your skin type: 1 for Dry, 2 for Combination, 3 for Oily, or 4 for Sensitive. "; //Error 1: Missing Semicolon
    cin >> userInput;
    ...
    case 4:
        ...
        break; //Error 2: Missing "break" statement that ensures the code corresponding to this case is executed.
    default:
