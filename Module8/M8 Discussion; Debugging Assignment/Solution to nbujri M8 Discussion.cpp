...
int main()
{
    ...
    //student objects
    Student student1 = Student("john", "doe", dorm1); //Error 1: included "dorm1" since there was a missing argument for student1
    Student student2 = Student("jane", "doe", dorm2);

    // display info for student 1 and 2
    student1.displayStudentInfo();
    student2.displayStudentInfo(); //Error 2: added missing parentheses after "displayStudentInfo" function call 
