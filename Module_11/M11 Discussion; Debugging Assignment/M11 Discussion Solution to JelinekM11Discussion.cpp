...
int main() {
    ...
    cout << "The maximum of " << i1 << " and " << i2 << " is " << findMax(i1, i2) << endl; 
    //Error 1: Changed "i" to "i1" in the first cout 
    cout << "The maximum of " << f1 << " and " << f2 << " is " << findMax(f1, f2) << endl;
    cout << "The maximum of " << c1 << " and " << c2 << " is " << findMax(c1, c2) << endl;
    //Error 2: Changed typo "finMax" to "findMax"
