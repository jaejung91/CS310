...
* File Name: M11 Discussion Solution; Debugging Assignment
* Date: 5/23/2024
*
...
int main()
{
    ...
    for (int i = 0; i < 5; ++i) //loop for the input  //Error 2: added "++" for the increment operator so it increments value of i by 1 after each iteration 
    {
        cout << "Number " << i + 1 << ": ";
        cin >> numbers[i];
    }
    ...
    for (int i = 1; i < 5; ++i) //Error 2: Added missing loop control variable "i" so changed to int "i" = 1.
    {
