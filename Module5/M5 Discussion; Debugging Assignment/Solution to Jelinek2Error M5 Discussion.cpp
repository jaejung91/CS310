...
* Date: 4/11/2024
* Description: This program has two user defined functions, one that adds and one that subtracts, two numbers. 
* There are two errors in here to check for.
*/
...
int add(int a, int b) {  //Error 1: Changed in to int - typo 
    return (a + b);
}
...
int main(){ //Error 2: Added missing ) parentheses. 
    // variables
    int num1 = 289;
    int num2 = 55;
